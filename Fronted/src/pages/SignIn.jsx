...
function SignIn() {
  ...
  //   try{
  //     let result = await  axios.post(`http://localhost:/5000/api/auth/signup`,{
  //       name,email,password
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="min-w-[150px] h-[60px] mt-[30px] text-black font-semibold bg-white rounded-full text-[19px]" onClick={handleSignIn} disabled ={loading}>
